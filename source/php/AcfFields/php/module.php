<?php 
    ...
    'fields' => array(
        ...
        7 => array(
            'key' => 'field_6a27eaf42e02f',
            'label' => __('Exkludera specifika länkar', 'modularity-alingsashero'),
            'name' => 'excludetree_custom_links',
            'aria-label' => '',
            'type' => 'textarea',
            'instructions' => __('En länk per rad, exempelvis<br>
<br>
/arbete/lediga-jobb<br>
/trafik-och-gator', 'modularity-alingsashero'),
            'required' => 0,
            'conditional_logic' => 0,
            'wrapper' => array(
                'width' => '',
